                                                    ...
                                                    try:
                                                        ...
                                                        with open(filename, "r") as f:
                                                            ...
                                                            for clf_idx in range(n_models):
                                                                ...
                                                                data_d[str(n_models)+"_models_"+str(sim_thr)+"_sim_thr"][n_estimators][input_size]["total_decoding_time"]+=metrics[f"decoding{clf_idx}_time"]

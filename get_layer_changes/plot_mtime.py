...
mtime_log = './mtime.log'
mtime_pdf = './mtime.pdf'
# layer_path = '/home/cc/test_venv/venv/lib/python3.9/site-packages'
# mtime_log = '/home/cc/test_venv/mtime.log'
# mtime_pdf = '/home/cc/test_venv/mtime.pdf'
...
for root, dirs, files in os.walk(layer_path):
    for filename in files:
        ...
        if os.path.getmtime(os.path.join(root, filename)) > 0:
...
ax.hist(ts_l, density=False, bins=300)  # density=False would make counts

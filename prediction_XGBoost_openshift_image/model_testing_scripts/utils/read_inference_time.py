...
for dataset in ["data_4"]:
    data_dir = ""
    for (with_filter, freq) in [("True", 300)]:
        for n_jobs in [32]:
            for clf_njobs in [32]:
                                            ...
                                            for i in range(n_models):
                                                ...
                                                for test_sample_batch_idx in [0]:
                                                    ...
                                                    if os.path.isfile(filename):
                                                        ...
                                                        print(filename)
                                            data_d[str(n_models)+"_models"][n_estimators][input_size]["traintime"].append(float("inf"))
                                            data_d[str(n_models)+"_models"][n_estimators][input_size]["samplesize"].append(float("inf"))
                                            data_d[str(n_models)+"_models"][n_estimators][input_size]["dimensions"].append(float("inf"))
                                        for shuffle_idx in range(3):
                                            for test_sample_batch_idx in [0]:
